...
import { MdChevronLeft, MdChevronRight, MdChevroRight } from 'react-icons/md';
...
const Row = ({ title, fetchURL, rowID }) => {
    ...
    return (
        <>
            ...
            <div id={'slider' + rowID} className="w-full h-full overflow-x-scroll whitespace-nowrap scrol-smoth scrollbar-hide relativee">
                {movies.map((item, id) => (
